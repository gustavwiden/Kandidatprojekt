...
Optimize: optimize_SLE_PK.py                         // Optimal params will be saved in best_SLE_PK_result.json, where SLE_CL is only parameter not fixed
Plot: plot_SLE_PK_simulation.py

// Figure 14: PD plot of SLE
Model: mPBPK_SLE_model.txt                           // Use output PD_sim
Optimize: optimize_SLE_PD.py                         // Optimal params will be saved in best_SLE_PD_result.json, where SLE_CL is only parameter not fixed
