...
with open("../Data/HV_PK_data.json", "r") as f:
    HV_PK_data = json.load(f)

# Load HV PD data
with open("../Data/HV_PD_data.json", "r") as f:
...
best_result_path = os.path.join(output_dir, 'best_result_80_pdc_mm2_test.json')
...
acceptable_params_path = os.path.join(output_dir, 'acceptable_params_80_pdc_mm2_test.json')
...
with open(os.path.join(output_dir, 'acceptable_params_80_pdc_mm2_test.csv'), 'w', newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerows(acceptable_params)

# Save all acceptable parameter sets to a JSON file
with open(os.path.join(output_dir, 'acceptable_params_80_pdc_mm2_test.json'), 'w') as f:
    json.dump(acceptable_params, f, cls=NumpyArrayEncoder)

# Save the best parameter set to a JSON file
with open(os.path.join(output_dir, 'best_result_80_pdc_mm2_test.json'), 'w') as f:
