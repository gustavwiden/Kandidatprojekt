...
def plot_all_doses_with_uncertainty(selected_params, acceptable_params, sims, PK_data, time_vectors, save_dir='../../../Results/SLE/Skin/PK', feature_to_plot='PK_sim'):
    ...
    for i, experiment in enumerate(PK_data):
        ...
        # Calculate AUC over the entire simulation
