...
def plot_all_doses_with_uncertainty(selected_params, acceptable_params, sims, PD_data, time_vectors, save_dir='../../../Results/SLE/Skin/PD', feature_to_plot='PD_sim_skin'):
...
plot_all_doses_with_uncertainty(SLE_params, acceptable_params, model_sims, PD_data, time_vectors)
