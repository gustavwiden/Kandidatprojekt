...
def plot_all_doses_with_high_low_pdc_uncertainty_gradient(selected_param_sets, acceptable_params, sim_sets, PD_data, time_vectors, save_dir='../../../Results/SLE/Skin/PD', feature_to_plot='PD_sim_skin'):
    ...
    for i, experiment in enumerate(PD_data):
        ...
        for params in acceptable_params:
            try:
                ...
                y_sim = model_sims[experiment].feature_data[:, 3]
