...
mPBPK_model = sund.load_model("mPBPK_model")
...
mPBPK_model_sims = {
    ...
    'IVdose_10_HV': sund.Simulation(models = mPBPK_model, activities = IV_10_HV, time_unit = 'h'),
...
def plot_fig(params, sims, color='g', save_dir='../Results/Skin/PK'):
