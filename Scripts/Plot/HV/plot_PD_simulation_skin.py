...
def plot_fig(params, sims, color='g', save_dir='../Results/Skin/PD'):
    ...
    for experiment in PD_data:
        ...
        plt.title(f"PD simulation in skin for {experiment}")
        plt.xlabel('Time [Hours]')
        plt.ylabel('BDCA2 levels on pDCs (% Change from Baseline) (µg/ml)')

        # Save figure with PD-specific name
        filename = f"PD_{experiment}_simulation_in_skin.png"
